...
4. [Components (Phase 1)](#components-phase-1)
	...
	- [Component - widgetConsent](#component---widget)
...
| widgetConsent | `widgetConsent`  | `component` |
| AppPromo | `appPromo`  | `component` |
| widgetMaxResendMessage | `widgetMaxResendMessage`  | `String` |
| widgetNavigationVariant | `widgetNavigationVariant`  | `String` |
| widgetTrustBannerText | `widgetTrustBannerText`  | `String` |
| widgetMaxResendAttempts | `widgetMaxResendAttempts`  | `Integer` |
...
### Component - widgetConsent

**CMS Key:** `widgetConsent`  
  ...
  "data": [
    {
      ...
      "subProduct": "motor",
      "components": {
        "getStarted": { /* ...see sample above... */ },
        "learnMoreCards": { /* ...see sample above... */ },
        "widgetConsent": { /* ...see sample above... */ },
        "appPromo": { /* ...see sample above... */ },
        "widgetMaxResendMessage": "You have reached the maximum number of resend attempts.",
        "widgetNavigationVariant": "stepper",
        "widgetTrustBannerText": "Your data is secure with us.",
