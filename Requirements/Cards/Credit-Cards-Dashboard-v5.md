...
**Collection Name:** `cards_dashboard_pages`  
**Singular Name:** `cards-dashboard-page`  
**Plural Name:** `cards-dashboard-pages`  
...
| `headerLogo` | media (image) | No | - | - | Header logo image (desktop & mobile header) |
| `headerLogoAlt` | string | No | `"ABCD Logo"` | - | Alt text for header logo |
| `mobileHeaderLogo` | media (image) | No | - | - | Mobile header logo image (used as src string, no `<Logo>` wrapper) |
...
| `disclaimerLinkHref` | string | No | `"https://www.adityabirlacapital.com/abcd/terms-conditions"` | - | Disclaimer CTA link URL |
...
```json
{
  "data": {
    ...
    "disclaimerLinkHref": "https://www.adityabirlacapital.com/abcd/terms-conditions",
  ...
  "data": [
    {
      ...
      "headerLogoAlt": "ABCD Logo",
      "headerLogo": { "id": 5, "documentId": "abc5", "url": "/uploads/abcd-logo.svg", "mime": "image/svg+xml" },
      "mobileHeaderLogo": { "id": 6, "documentId": "abc6", "url": "/uploads/abcd-logo.svg", "mime": "image/svg+xml" },
